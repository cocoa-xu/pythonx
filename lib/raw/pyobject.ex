defmodule Pythonx.Raw.PyObject do
  ...
  Only returns `:error` if it cannot allocate memory for the object,
  ...
  """
  @spec get_attr(reference(), reference()) :: reference() | nil
  def get_attr(ref, attr_name), do: Pythonx.Nif.py_object_get_attr(ref, attr_name)

  @doc """
  This is the same as `get_attr/2`, but `attr_name` is specified as a UTF-8 encoded bytes string, rather than a `PyObject`.
  """
  @spec get_attr_string(reference(), String.t()) :: reference() | nil
  def get_attr_string(ref, attr_name), do: Pythonx.Nif.py_object_get_attr_string(ref, attr_name)
  ...
  """
  @spec generic_get_attr(reference(), reference()) :: reference()
  ...
  Returns false on failure; return true on success. This is the equivalent of the Python statement `o.attr_name = v`.
  ...
  """
  @spec set_attr(reference(), reference(), reference() | nil) :: boolean()
  def set_attr(ref, attr_name, v), do: Pythonx.Nif.py_object_set_attr(ref, attr_name, v)
  ...
  but there are currently no plans to remove it.
  """
  @spec set_attr_string(reference(), String.t(), reference() | nil) :: boolean()
  def set_attr_string(ref, attr_name, v),
    do: Pythonx.Nif.py_object_set_attr_string(ref, attr_name, v)
  ...
  or deleted in the object’s `__dict__` (if present). On success, `true` is returned, otherwise an `AttributeError`
  is raised and `false` is returned.
  """
  @spec generic_set_attr(reference(), reference(), reference()) :: boolean()
  def generic_set_attr(ref, attr_name, v),
    do: Pythonx.Nif.py_object_generic_set_attr(ref, attr_name, v)
  ...
  def del_attr(ref, attr_name), do: Pythonx.Nif.py_object_del_attr(ref, attr_name)
  ...
  def del_attr_string(ref, attr_name), do: Pythonx.Nif.py_object_del_attr_string(ref, attr_name)
  ...
  def is_true(ref), do: Pythonx.Nif.py_object_is_true(ref)
  ...
  On failure, raises SystemError.
  """
  @spec type(reference()) :: reference() | :error
  def type(ref), do: Pythonx.Nif.py_object_type(ref)

  @doc """
  Return the length of object o. If the object o provides either the sequence and mapping protocols,
  ...
  - `nil` on failure,
  - `:error` if the system is out of memory.
  """
  @spec repr(reference()) :: reference() | nil | :error
  def repr(o), do: Pythonx.Nif.py_object_repr(o)

  @doc """
  As PyObject_Repr(), compute a string representation of reference `o`,
  ...
  - `:error` if the system is out of memory.
  """
  @spec ascii(reference()) :: reference() | nil | :error
  ...
  - `:error` if the system is out of memory.
  """
  @spec str(reference()) :: reference() | nil | :error
  ...
  - `:error` if the system is out of memory.
  """
  @spec bytes(reference()) :: reference() | nil | :error
